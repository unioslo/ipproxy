...
var postToAnalytics = function (query, ip, collectStartHrtime, clientResponseDiff) {
...
var collect = function (req, res) {
  ...
  // referer and userAgent are available in Javascript (document.referrer and navigator.userAgent)
  // and should already have been added as the ua and dr parameters by analytics.js, so don't mess with them
  ...
  setImmediate(function () {
    postToAnalytics(req.query, userIp, startHrtime, afterResponseDiff);
  });
