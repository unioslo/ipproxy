...
var postToAnalytics = function (userAgent, query, ip, collectStartHrtime, clientResponseDiff) {
...
var collect = function (req, res) {
  ...
  setImmediate(function () {
    postToAnalytics(userAgent, req.query, userIp, startHrtime, afterResponseDiff);
  });
